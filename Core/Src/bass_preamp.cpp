...
void BassPreAmp::process(float32_t *pLeft, float32_t *pRight,
  ...
  arm_biquad_cascade_df1_f32(&bassL_, pLeft, pLeft, numFrames);
  arm_biquad_cascade_df1_f32(&bassR_, pRight, pRight, numFrames);
  arm_biquad_cascade_df1_f32(&trebleL_, pLeft, pLeft, numFrames);
  arm_biquad_cascade_df1_f32(&trebleR_, pRight, pRight, numFrames);
